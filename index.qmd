...
universities <- data.frame(
  ...
  logo_url = c("assets/emory.png", "assets/gemelli.jfif.png", "assets/michigan.png", "assets/karolinska.png", "assets/lund.png","assets/mskcc.png","assets/radbound.png","assets/sanraf.png","assets/uhn.jpg","assets/Uni-Bonn.png","assets/chicago.png","assets/ucla.png","assets/ucsf.png","assets/ucl.png","assets/ku.png","assets/france.jpg","assets/oxford.png","assets/vienna.jpg","assets/vanderbilt.png","assets/yale.png")
)
