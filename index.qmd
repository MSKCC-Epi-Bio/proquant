...
universities <- data.frame(
  university = c("University of Copenhagen", "Emory", "Gemelli", "Michigan Medicine", "Karolinska Institute",
                 ...
                 "University of Oxford", "University of Vienna", "Vanderbilt", "Yale", "Georgetown University Medical Center", "Royal Brisbane and Women's Hospital", "University Hospitals Leuven", "Alfred Health", "Amsterdam University Medical Center", "University of San Carlos", "University of Turku", "Monash University", "University Hospital of Zürich", "Barts Cancer Institute", "Northern Westchester Hospital", "Urological Research Network", "University of California, Irvine", "University of Padua", "German Cancer Research Center", "Erasmus University Medical Center", "Hospital Clínic de Barcelona", "Centre of Postgraduate Medical Education", "Cleveland Clinic"),
  ...
  location = c("Copenhagen, Denmark", "Atlanta, Georgia, USA", "Rome, Italy", "Ann Arbor, Michigan, USA",
               ...
               "San Francisco, California, USA", "London, UK", "Kansas City, Missouri, USA",
                ...
                "New Haven, Connecticut, USA", "Washington, DC, USA", "Brisbane, Australia", "Leuven, Belgium", "Melbourne, Australia", "Amsterdam, Netherlands", "Madrid, Spain", "Turku, Finland", "Melbourne, Australia", "Zurich, Switzerland", "London, UK", "Mount Kisco, New York", "Miami, Florida", "Irvine, California, USA", "Padua, Italy", "Heidelberg, Germany", "Rotterdam, Netherlands", "Barcelona, Spain", "Warsaw, Poland", "Cleveland, Ohio, USA"),

  logo_url = c("assets/copenhagen.png", "assets/emory.png", "assets/gemelli.jfif.png", "assets/michigan.png", "assets/karolinska.png", "assets/lund.png", "assets/mskcc.png", "assets/martini.png", "assets/radbound.png", "assets/sanraf.png", "assets/uhn.jpg", "assets/Uni-Bonn.png", "assets/chicago.png", "assets/ucla.png", "assets/ucsf.png", "assets/ucl.png", "assets/ku.png", "assets/france.jpg", "assets/oxford.png", "assets/vienna.jpg", "assets/vanderbilt.jpg", "assets/yale.png", "assets/georgetown.jpg", "assets/brisbane.png", "assets/leuven.png", "assets/alfred.jpg", "assets/amsterdam.png", "assets/sancarlos.JPG", "assets/turku.png", "assets/monash.png", "assets/zurich.jpg", "assets/barts.jpg", "assets/nw.jpg", "assets/ur.png", "assets/uci.jpg", "assets/padua.jpg", "assets/dkfz.png", "assets/erasmus.png", "assets/hcb.png", "assets/cmkp.png", "assets/cleavelandclinic.jpg")
)
