...
universities <- data.frame(
  ...
  location = c("Copenhagen, Denmark", "Atlanta, Georgia, USA", "Rome, Italy", "Ann Arbor, Michigan, USA", 
              ...
              "New Haven, Connecticut, USA","Washington, DC, USA","Brisbane, Australia","Leuven, Belgium","Melbourne, Australia","Amsterdam, Netherlands","Madrid, Spain","Turku, Finland","Melbourne, Australia","Zürich, Switzerland","London, UK","Mount Kisco, New York","Miami, Florida"),
